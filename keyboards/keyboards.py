...
def admin_kb():
    ...
    b.row(
        InlineKeyboardButton(text="📡 Live Monitor",  callback_data="adm_live"),
...
def mytest_settings_kb(tid, is_paused=False, is_admin=False):
    ...
    b.row(InlineKeyboardButton(text="🔄 Test turini o'zgartirish", callback_data=f"edit_visibility_{tid}"))
